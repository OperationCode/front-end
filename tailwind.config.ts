  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        error: hslWithOpacity('var(--error-hsl)'),
        'error-deep': 'hsl(var(--error-deep-hsl) / <alpha-value>)',
        success: hslWithOpacity('var(--success-hsl)'),
        'success-deep': 'hsl(var(--success-deep-hsl) / <alpha-value>)',
        warning: hslWithOpacity('var(--warning-hsl)'),
      ...
      boxShadowColor: {
        ...
        success: hslWithOpacity('132 35% 88%'),
        'success-deep': 'hsl(132 60% 23% / <alpha-value>)',
        error: hslWithOpacity('355 70% 91%'),
        'error-deep': 'hsl(355 63% 34% / <alpha-value>)',
        warning: hslWithOpacity('46 100% 90%'),
