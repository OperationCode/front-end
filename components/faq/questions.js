...
const questions = () => ({
  general: [
    ...
    },
    {
      ...
      answer: (
        <>
          Our friends at the New York City-based, The Flatiron School created{' '}<OutboundLink analyticsEventLabel="QnA Link" href="https://learn.co/">Learn.co</OutboundLink>, an online platform to get introduced to web development and the popular web framework, Ruby on Rails. Request an invite <OutboundLink analyticsEventLabel="QnA Link" href="https://learn.co/join/operation-code">here</OutboundLink> and then join the #learn-dot-co channel in our Slack. Another resource is{' '} <OutboundLink analyticsEventLabel="QnA Link" href="https://www.learnhowtoprogram.com/courses"> learnhowtoprogram.com </OutboundLink>, a resource maintained by Epicodus.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          Operation Code is different in that we don&apos;t have regular business office hours. The team can usually be found in, our{' '}
          <OutboundLink analyticsEventLabel="QnA Link" href="http://operation-code.slack.com">Slack channel</OutboundLink>{' '}, or on{' '}
          <OutboundLink analyticsEventLabel="QnA Link" href="https://github.com/OperationCode/operationcode">GitHub</OutboundLink>{' '},
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <OutboundLink analyticsEventLabel="QnA Link" href="http://op.co.de/volunteer" target="_blank">
            volunteers
          </OutboundLink>{' '}
          and interns. The larger our community, the more we can spread the word about our work.
          Also, remember that every {' '}<OutboundLink analyticsEventLabel="QnA Link" href={donateLink}>donation</OutboundLink>{' '}, no
    ...
    },
    {
      ...
      answer: (
        <>
          We primarily use{' '}
          <OutboundLink analyticsEventLabel="QnA Link" href="https://twitter.com/operation_code">Twitter</OutboundLink> and{' '}
          <OutboundLink analyticsEventLabel="QnA Link" href="http://facebook.com/operationcode.org">Facebook</OutboundLink>{' '} to put
          out updates and news since it&apos;s faster to put out info and respond. Given our chosen craft, we don&apos;t do regular emails as often.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          <OutboundLink analyticsEventLabel="QnA Link" href="https://medium.com/@operation_code">blog</OutboundLink>, write to{' '}
          <OutboundLink analyticsEventLabel="QnA Link" href="mailto:staff@operationcode.org">staff@operationcode.org</OutboundLink>{' '}
  ...
  donation: [
    {
      ...
      answer: (
        <>
          ...
          <OutboundLink analyticsEventLabel="QnA Link" href={donateLink}>here</OutboundLink>{' '}.
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <>
          When you visit{' '}
          <OutboundLink analyticsEventLabel="QnA Link" href="https://smile.amazon.com/ch/47-4247572">
