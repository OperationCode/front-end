...
describe('MultiStepForm', () => {
  ...
  it('should handle error on final submit if success handler throws', async () => {
    const onFinalSubmitMock = vi.fn().mockRejectedValue(new Error(networkErrorMessages.serverDown));
