...
export default () => (
  <>
    ...
    <Section hasHeadingLines={false} theme="white">
      ...
      <p>
        ...
        carefully before using the https://www.operationcode.org/ website (the &quot;Service&quot;)
        operated by Operation Code (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
      </p>
      <p>
      ...
      <p>
        ...
        Content is yours (you own it) and/or you have the right to use it and the right to grant us
        the rights and license as provided in these Terms, and (ii) that the posting of your Content
      ...
      <p>
        ...
        through the Service. However, by posting Content using the Service you grant us the right
        and license to use, modify, publicly perform, publicly display, reproduce, and distribute
        such Content on and through the Service. You agree that this license includes the right for
        us to make your Content available to other users of the Service, who may also use your
      ...
      <p>
        ...
        connection with any product or service without the prior written consent of Operation Code.
      </p>
      ...
      <p>
        You acknowledge and agree that Operation Code shall not be responsible or liable, directly
      ...
      <p>
        ...
        expenses (including but not limited to attorney&apos;s fees), resulting from or arising out
        of a) your use and access of the Service, by you or any person using your account and
