...
export default () => (
  <React.Fragment>
    <div>
      <Head title="About" />
      <HeroBanner
        imageSrc={`${s3}heroBanners/stock_family-2.jpg`}
        title="A non-profit charity helping the military 
        community learn software development, enter the 
        tech industry, and code the future."
      />

      <Section id="" theme="white" title="About">
        <p>
          ...
          coding bootcamps. You can read about our organization &apos;s history here
        </p>
        <p>
          Aside from our work on the Hill, we offer many services to the military community and are
          continuing to expand our offerings as often as possible. First and foremost, our staff
          works tirelessly to provide mentorship for veterans interested in learning about various
          tech careers. Dozens of software engineers, product managers, system architects, security
      ...
      <Section id="" theme="grayLight" title="What We Do">
        <ImageCard
      ...
      <Section id="" theme="grayLight" title="Mission">
        <p>
      ...
      <Section id="" theme="grayLight" title="Core Values">
        <ValueCard
          name="Integrity"
