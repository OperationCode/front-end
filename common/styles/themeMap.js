...
export const rgbPrimary = "rgb(62, 214, 240)";
export const rgbSecondary = "rgb(37, 46, 62)";
export const success = "hsla(134, 41%, 88%, 0.6)";
export const successDeep = "hsl(134, 12%, 33%)";
export const warning = "hsla(46, 100%, 90%, 0.6)";
export const warningDeep = "hsl(46, 42%, 32%)";
export const error = "hsla(355, 70%, 91%, 0.6)";
export const errorDeep = "hsl(355, 30%, 30%)";
